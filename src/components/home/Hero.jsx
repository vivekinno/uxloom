...
const Hero = () => {
  return (
   <div className="w-full bg-white font-poppins">
     <div className="px-6 py-4 sm:px-10 sm:py-6 md:px-32 md:py-12 lg:px-32 lg:py-12 xl:px-32 xl:py-12 2xl:px-32 2xl:py-12 flex flex-col-reverse lg:flex-row justify-center items-center gap-4 lg:gap-0">
      <div className="flex flex-col justify-center items-left  md:w-[50%] lg:w-[50%] xl:w-[50%] lg:gap-16  gap-6 ">
        <div className="flex flex-col text-left items-center justify-center lg:w-[80%] gap-4">
          <h1 className="text-2xl md:text-3xl lg:text-[40px] lg:leading-[48px] font-bold ">Transform Your Digital Presence with Impactful Design</h1>
      ...
      <div className="flex justify-center items-center sm:w-full md:w-[50%] lg:w-[50%] xl:w-[50%] ">
         <img src="/images/heropage.gif" alt="gif" />
      </div>
    </div>
   </div>
  );
