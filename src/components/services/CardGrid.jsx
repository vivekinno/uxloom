  ...
  return (
    <>
      <div className="flex flex-col text-center justify-center items-center gap-2">
        ...
        <h1 className="text-2xl md:3xl lg:text-[32px] lg:leading-[36px] font-bold text-[#000000] lg:w-[60%]">We turn simple ideas into an extraordinary digital design transformations.</h1>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-6  ">
          {services.map((service, index) => (
            ...
            >
              <span className="text-[#333333] group-hover:text-[#00CCCC]  font-medium">{service.name}</span>
