      ...
      <div className=" px-6 py-4 sm:px-10 sm:py-6 md:px-32 md:py-6 lg:px-32 lg:py-6 xl:px-32 xl:py-6 2xl:px-32 2xl:py-6 flex justify-between items-center shadow-md">
        ...
        <div className="hidden lg:flex text-base font-medium gap-8">
          {navLinks.map((link) => (
            <Link
              key={link.to}
              to={link.to}
              className="text-[#333333] hover:text-[#00CCCC]"
            >
              {link.label}
            </Link>
          ))}
        ...
        <button className="lg:hidden z-50" onClick={toggleMenu}>
          {isOpen ? (
            ...
            <IoMenu size={24} className="text-[#00CCCC]" />
          )}
        </button>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex gap-2">
                  ...
                  <span
                    ...
                    onClick={() => (window.location.href = "tel:+918178652544")}
                  >
                    +91 81786 52544
                  </span>
                </div>
                <div className="flex gap-2">
                  ...
                  <span
                    className="text-sm cursor-pointer"
                    onClick={() =>
                      (window.location.href = "mailto:hello@uxloom.in")
                    }
                  >
                    hello@uxloom.in
                  </span>
